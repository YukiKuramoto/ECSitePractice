                              ...
                              <div class="-m-2">
                                ...
                                <div class="p-2 w-1/2 mx-auto">
                                  <div class="relative">
                                    ...
                                    <div class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $owner->shop->name }}</div>
                                  </div>
                                </div>
                                <div class="p-2 w-1/2 mx-auto">
                                  <div class="relative">
                                ...
                                <div class="p-2 w-full mt-4 flex justify-around">
                                  ...
                                  <button type="submit" class="bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">更新する</button>
                                </div>
                              </div>
                          </form>
                        </div>
